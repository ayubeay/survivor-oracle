...
try{var files=require("fs").readdirSync(require("path").dirname(require("./db").DB_PATH));console.log("[attest] /app/data contents: "+JSON.stringify(files));}catch(e){console.log("[attest] /app/data error: "+e.message);}
